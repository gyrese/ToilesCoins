...
export default function Admin() {
    ...
    const addeventFromFacebook = async (fbEvent: any) => {
        ...
        try {
            ...
            setMessage(`✅ �V�NEMENT "${fbEvent.name}" ajouté`);
            ...
            console.error(error);
            setMessage("❌ Erreur lors de l'ajout du �V�NEMENT");
        }
    };
    ...
    const saveeventResults = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setMessage(`✅ Résultats enregistrés ! ${eventForm.winner} remporte le �V�NEMENT !`);
    ...
    const deleteevent = async (id: string) => {
        if (!confirm("Supprimer ce �V�NEMENT ?")) return;
        setMessage("");
        try {
            await deleteDoc(doc(db, "events", id));
            setevents(events.filter(t => t.id !== id));
            setMessage("✅ �V�NEMENT supprimé");
        } catch (error) {
            console.error(error);
            setMessage("❌ Erreur technique");
        }
        ...
        <>
            ...
            <main className="layout-container pb-32">
                ...
                <div className="neo-card">
                            ...
                            <form onSubmit={handleCreateEvent} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="neo-input"
                                        placeholder="�V�NEMENT Mario Kart"
                                        value={eventTitle}
                    ...
                    {activeTab === "events" && (
                        <div>
                            <h2 className="text-xl font-black uppercase mb-6">🏆 Gestion des �V�NEMENTs</h2>

                            {/* Formulaire d'ajout manuel de �V�NEMENT */}
                            <div className="mb-8 p-6 bg-yellow-100 border-2 border-black">
                                <h3 className="font-black uppercase mb-4">➕ Ajouter un �V�NEMENT</h3>
                                <form onSubmit={async (e) => {
                                    ...
                                    <div>
                                        <label className="block font-bold mb-1 text-sm">NOM DU �V�NEMENT *</label>
                                        <input
                                            type="text"
                                            name="eventName"
                                            required
                                            className="w-full p-2 border-2 border-black"
                                            placeholder="Ex: �V�NEMENT Mario Kart Décembre 2024"
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full p-2 border-2 border-black"
                                            rows={3}
                                            placeholder="Description du �V�NEMENT..."
                                        ></textarea>
                                    </div>
                            ...
                            {editingevent && (
                                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                                    <div className="bg-white border-4 border-black p-6 max-w-md w-full">
                                        <h3 className="font-black text-xl mb-4">🏆 RÉSULTATS DU �V�NEMENT</h3>
                            ...
                            {/* Liste des �V�NEMENTs */}
                            <div>
                                <h3 className="font-black uppercase mb-4">📋 HISTORIQUE DES �V�NEMENTS</h3>
                                {events.length === 0 ? (
                                    <div className="text-center p-8 bg-gray-100 border-2 border-black">
                                        <p className="font-bold">Aucun �V�NEMENT enregistré</p>
                                        <p className="text-sm mt-2">Ajoutez votre premier �V�NEMENT ci-dessus !</p>
                                    </div>
                                ) : (
                                    <div className="space-y-4">
